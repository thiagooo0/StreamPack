 ...
 */
open class ScreenCaptureSrtLiveStreamer(
    context: Context,
    tsServiceInfo: ServiceInfo,
    logger: ILogger,
    bitrateRegulatorFactory: ISrtBitrateRegulatorFactory?,
    bitrateRegulatorConfig: BitrateRegulatorConfig?
) : BaseScreenCaptureStreamer(
    context,
    tsServiceInfo,
    SrtProducer(context, logger = logger),
    logger
),
    ILiveStreamer {
    ...
    /**
     * Builder class for [SrtLiveStreamer] objects. Use this class to configure and create an [SrtLiveStreamer] instance.
     */
    open class Builder(
        ...
        /**
         * Combines all of the characteristics that have been set and return a new [SrtLiveStreamer] object.
         *
         * @return a new [SrtLiveStreamer] object
         */
        @RequiresPermission(allOf = [Manifest.permission.RECORD_AUDIO, Manifest.permission.CAMERA])
        override fun build(): ScreenCaptureSrtLiveStreamer {
            val streamer = ScreenCaptureSrtLiveStreamer(
                context,
                serviceInfo,
                logger,
